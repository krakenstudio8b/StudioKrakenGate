...
document.addEventListener('authReady', () => {
    ...
    // Mostra loading nella sezione Visione mentre Firebase carica i dati
    const targetsContainer = document.getElementById('targets-container');
    if (targetsContainer) {
        targetsContainer.innerHTML = '<div class="col-span-full text-center py-8 text-gray-400"><i class="fa-solid fa-spinner fa-spin mr-2"></i>Caricamento obiettivi...</div>';
    }
